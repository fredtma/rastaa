...
$routeProvider
   ...
   $rootScope.usr={"display":"Frederick Tshimanga","title":"Web Developer","img":"images/avatar.jpg"};
   $rootScope.breadcrum=[{"class":"","text":"Home","link":"#genesis"},{"class":"active","text":"User Profile","link":"#profile"}];
   $rootScope.crud={};
}]);
(function(){
   ...
   var scope={
      "profile":{
         "mensa":"users",
         "creation":{"jesua":{"type":"TEXT","key":"unique"},"created":{"type":"TEXT"},"modified":{"type":"TIMESTAMP","default":"CURRENT_TIMESTAMP"},"username":{"type":"TEXT","unique":true},"firstname":{"type":"TEXT","null":true},"lastname":{"type":"TEXT"},"email":{"type":"TEXT","null":true},"password":{"type":"TEXT","null":true},"mobile":{"type":"TEXT"},"title":{"type":"TEXT"},"communication":{"type":"TEXT"} },
         "extra":{"title":{"enum":['Mr.','Mrs.','Miss.','Doc.','Sir.']},"communication":{"enum":['email','sms','mobile','browser']}},
         "details":{"created":d, "modified":d,"jesua":null,"firstname":null,"lastname":null,"username":null,"email":null,"mobile":null,"title":"Mr.","communication":"email"},
